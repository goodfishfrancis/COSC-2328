...
function printButtonsForm() {
    ...
    print
        ...
        "               <form action='asg6.php' method='post'>\n".
        "                   <input type='submit' name='btnAdd' value='Add Item' >\n".
        "                   <input type='submit' name='btnRemove' value='Remove All' onclick=\"confirm('WARNING: Delete all entries?')\">\n".
        "               </form> \n".
        "           </div> <!--/col-xs-8--> \n".
...
function printBlogEntryForm() {
    ...
    print
        "       <div class='row'> \n".
        "           <div class='col-xs-8'> \n".
        "               <form name='myForm' action='http://www.asolinge.create.stedwards.edu/cosc2328/asg6.php' method='post'> \n".
        "                   Blog Entry:<br> \n".
        "                   <textarea rows='4' cols='50' name='blog2' required class='mytext' maxlength='200'></textarea> \n".
...
function writeToFile($blog) {
    ...
    $myFile = fopen("blog2.log", "a") or die("Error!");
...
function displayBlogItems() {
    ...
    if (!file_exists("blog2.log")) {
        return;
    }
    $myFile = file("blog2.log") or die("Unable to open file!");
...
function clearAll() {
    ...
    if (file_exists("blog2.log")) {
        if (!unlink("blog2.log")) {
            print "Error deleting blog2.log";
        }
    }
    else {
        return;
